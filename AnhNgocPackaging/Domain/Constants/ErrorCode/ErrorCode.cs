...
namespace AnhNgocPackaging.Domain.Constants.ErrorCode
{
    public static class ErrorCode
    {
        ...
        public static void InitErrorDefine()
        {
            ...
            {
                string errorJson = File.ReadAllText($"{Directory.GetCurrentDirectory()}/Domain/Constants/ErrorCode/ErrorCodes.json");
